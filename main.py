...
def set_environment():
    ...
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"D:\AutoWebScraper\auto-web-scraper-e1021935ef6d.json"
...
def scrape_job_postings(driver):
    ...
    time.sleep(2)  # Ensure the page has loaded completely
...
def main():
    ...
    try:
        ...
        upload_df_to_bigquery(jobs_df, 'auto-web-scraper', 'job_scraper', 'job_postings')
    finally:
        driver.quit()
